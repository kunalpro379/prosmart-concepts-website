...
const ProductDetail = () => {
  ...
  useEffect(() => {
    ...
    const loadProduct = async () => {
      try {
        ...
        // Parse the id: supports both "prod_0001cat_001" and legacy "prod_0001--cat_001"
        let productId = "";
        let categoryId = "";
        ...
        if (id.includes("--")) {
          ...
          if (catIndex === -1) {
            ...
            toast({
              ...
              description: "The product URL is not formatted correctly.",
              variant: "destructive",
            });
            navigate("/products");
            return;
        ...
        console.log('Looking for product:', { productId, categoryId, originalId: id });
        
        // Fetch all products
        const data: ProductData = await fetchCategoriesWithProducts();
  ...
  if (loading || minLoadingTime || !product) {
